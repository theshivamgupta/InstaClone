...
CREATE_USER
mutation createUsers($codeforces: String, $email: String!, $name: String!, $profileImage: String!, $userId: String!, $username: String!) {
  insert_users(objects: {codeforces_handle: $codeforces, email: $email, name: $name, profile_image: $profileImage, user_id: $userId, username: $username}) {
    affected_rows
  }
}

UPDATE_USER
mutation updateUsers($id: uuid!, $name: String!, $username: String!, $email: String!, $codeforces: String!) {
  update_users(where: {id: {_eq: $id}}, _set: {name: $name, username: $username, email: $email, codeforces_handle: $codeforces}) {
    affected_rows
  }
}
